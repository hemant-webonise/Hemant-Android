...
//                  I was thinking now the send dat from the Broadcast receiver to the main activity
                    String send_text = "senderNum: " + senderNum + ", message: " + message;
                    Intent receive = new Intent(context, MainActivity.class);
                    receive.putExtra("message", send_text);
